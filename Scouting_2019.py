...
class Form(flask_wtf.Form):
    ...
    hab_start_robot = RadioField('What Habitat did the robot start in?', choices =[('0', 'Base'), ('1', 'Left 2nd Level'), ('2', 'Right 2nd Level') ('3', 'Top Level')], delfault="0")
    ...
    hatch_cargo = IntergerFiel('Hatch In Cargo', default=0, col_sm=6)
    ...
    hatch_dropped = IntegerField('Hatch Dropped', delfault=0, col_sm=4)
    ...
    hab_end_robot = RadioField('What Habitat did the robot end in?', choices =[('0', 'Base'), ('1', 'Left 2nd Level'), ('2', 'Right 2nd Level') ('3', 'Top Level'), ('4', 'Did not enter habitat')], delfault="4")

    mechanism_scr = RadioField('What mechanism did they use to interact meaningfully with the ball? How fast was said mechanism?', choices=[('0', 'Shooter'), ('1', 'Elevator'), ('2', 'Other')], default="2")

    comments_mechanism = TextAreaField('', col_lg=12)


    cool_factor = RadioField('Did they (bribe) give us stuff? Are they nice?', choices =[('0', 'Much Sadness'), ('1', 'Not very Dogelike things'), ('2', 'Very Swag')], default="0"